...
<body>
                            ...
                            <div class="singe_desc">
                                ...
                                <div class="comments">
                                    <ul class="links">
                                        ...
                                        <li><a href="" id="send <?= $post['id']; ?>"><i class="blog_icon3"></i><br><span id="likes <?= $post['id']; ?>"><?= $post['likes']; ?></span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('a.send <?= $post['id']; ?>').on('click', function() {
                $.ajax({
                        method: "POST",
                        url: "return.php",
                        data: {
                    ...
                    .done(function(likes) {
                        ...
                        $("#likes <?= $post['id']; ?>").text("Likes " + likes);
                    });
            })
        });
    </script>
